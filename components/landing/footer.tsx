        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/electrical" className="hover:text-primary">
                  Electrical
                </Link>
              </li>
              <li>
              ...
              <li>
                <button
                  onClick={() => scrollToSection?.(servicesRef as React.RefObject<HTMLElement>)}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/become-provider" className="hover:text-primary">
                  Join as Provider
                </Link>
              </li>
              <li>
                <button className="hover:text-primary">Resources</button>
              </li>
              <li>
                <button className="hover:text-primary">Provider FAQ</button>
              </li>
            </ul>
          </div>
          <div>
