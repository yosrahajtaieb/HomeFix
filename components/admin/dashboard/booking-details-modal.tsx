        ...
        <div className="sticky bottom-0 bg-gray-50 border-t px-6 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-2.5 text-red-600 border border-red-600 hover:bg-red-50 rounded-md font-medium transition-colors"
            >
              Delete Booking
            </button>
            ...
            <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3">
              {booking.status === "pending" && (
                <>
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-2.5 bg-red-600 text-white rounded-md hover:bg-red-700 font-medium transition-colors flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-2.5 bg-green-600 text-white rounded-md hover:bg-green-700 font-medium transition-colors flex items-center justify-center"
                  >
              ...
              {booking.status === "confirmed" && (
                <>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium transition-colors flex items-center justify-center"
                  >
                    <CheckCircle className="h-4 w-4 mr-2" />
                    Mark as Completed
                  </button>
              ...
              {(booking.status === "rejected" ||
                ...
                <button
                  onClick={onClose}
                  className="w-full sm:w-auto px-6 py-2.5 bg-gray-600 text-white rounded-md hover:bg-gray-700 font-medium transition-colors"
                >
                  Close
                </button>
              )}
